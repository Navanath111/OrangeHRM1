...
public class ReadFileData {
	...
	public static String fetchDataFromExcel(int row, int cell) throws EncryptedDocumentException, IOException 
	{
		...
		String path = "src"+File.separator+"test"+File.separator+"resources"+File.separator+"TestExel"+File.separator+"Book18.xlsx";
		...
		CellType type = c.getCellType();//return celltype
